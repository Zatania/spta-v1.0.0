...
import { resolveSchoolYearId, getCurrentSchoolYearId } from '../lib/schoolYear'
...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === 'POST') {
      ...
      if (session.user.role === 'teacher') {
        const allowed = await validateTeacherOwnsSection(session.user.id, section_id, currentSyId)
